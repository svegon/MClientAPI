 ...
 * summary statistics on a stream of shorts with:
 * <pre> {@code
 * ShortSummaryStatistics stats = ShortStream.collect(ShortSummaryStatistics::new, ShortSummaryStatistics::accept,
 *                                                      ShortSummaryStatistics::combine);
 * }</pre>
 *
 ...
 *     .collect(Collectors.summarizingShort(Person::getWeight));
 *}</pre>
 *
 ...
 * {@link CollectingUtil#summarizingShort(Object2ShortFunction)
 * Collectors.summarizingShort()} on a parallel stream, because the parallel
...
public class ShortSummaryStatistics implements ShortConsumer {
     ...
     * {@code Short.POSITIVE_INFINITY} min, {@code Short.NEGATIVE_INFINITY}
     ...
     * @since 10
     */
    public ShortSummaryStatistics(long count, short min, short max, long sum) throws IllegalArgumentException {
        if (count < 0L) {
    ...
    /**
     * Incorporate a new short value using Kahan summation /
    ...
    /**
     * Returns the minimum recorded value, {@code Short.MAX_VALUE} if no values were
     * recorded. Unlike the numerical comparison operators, this method
     * considers negative zero to be strictly smaller than positive zero.
     *
     * @return the minimum recorded value, {@code Short.MAX_VALUE}
    ...
    /**
     * Returns the maximum recorded value, {@code Short.MAX_VALUE}
     ...
     * {@code Short.MIN_VALUE} if no values were recorded
     */
