...
public abstract class PipelineHelper<P_OUT> {
     ...
     */
    public abstract<P_IN, S extends Sink<P_OUT>> S wrapAndCopyInto(S sink, Spliterator<P_IN> spliterator);
     ...
     */
    public abstract<P_IN> void copyInto(Sink<P_IN> wrappedSink, Spliterator<P_IN> spliterator);
     ...
     */
    public abstract <P_IN> boolean copyIntoWithCancel(Sink<P_IN> wrappedSink, Spliterator<P_IN> spliterator);
     ...
     *         {@code PipelineHelper}
     */
    public abstract Node.Builder<P_OUT> makeNodeBuilder(long exactSizeIfKnown, IntFunction<P_OUT[]> generator);
     ...
     * array, such as:
     * <pre>{@code
     *     stream.sorted().toPrimitiveArray();
     * }</pre>
     *
     * @param spliterator the source {@code Spliterator}
