 ...
 * stage implementing whose elements are of type {@code longs}.
 *
...
public abstract class LongPipeline<E_IN>
     ...
     */
    public LongPipeline(Supplier<? extends Spliterator<Long>> source,
     ...
     * @param parallel {@code true} if the pipeline is parallel
     */
    public LongPipeline(Spliterator<Long> source,
                 int sourceFlags, boolean parallel) {
        super(source, sourceFlags, parallel);
    }
     ...
     */
    public LongPipeline(AbstractPipeline<?, E_IN, ?> upstream, int opFlags) {
    ...
    public final LongStream distinct() {
        ...
        // An efficient version requires a longs-specific map/set implementation.
