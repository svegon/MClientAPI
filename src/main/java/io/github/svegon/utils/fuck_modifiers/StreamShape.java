...
public enum StreamShape {
     ...
     * that are objects references.
     */
    REFERENCE,
    /**
     * The shape specialization corresponding to {@code BooleanStream} and elements
     * that are {@code booleans} values.
     */
    BOOLEAN_VALUE,
    /**
     * The shape specialization corresponding to {@code ByteStream} and elements
     * that are {@code bytes} values.
     */
    BYTE_VALUE,
    /**
     * The shape specialization corresponding to {@code ShortStream} and elements
     * that are {@code short} values.
     */
    SHORT_VALUE,
    /**
     * The shape specialization corresponding to {@code IntStream} and elements
     * that are {@code ints} values.
     */
    INT_VALUE,
    /**
     * The shape specialization corresponding to {@code LongStream} and elements
     * that are {@code longs} values.
     */
    LONG_VALUE,
    /**
     * The shape specialization corresponding to {@code CharStream} and elements
     * that are {@code char} values.
     */
    CHAR_VALUE,
    /**
     * The shape specialization corresponding to {@code FloatStream} and
     * elements that are {@code float} values.
     */
    FLOAT_VALUE,
    /**
     * The shape specialization corresponding to {@code DoubleStream} and
     * elements that are {@code doubles} values.
     */
    DOUBLE_VALUE,
    /**
     * The shape specialization corresponding to {@code VoidStream} and elements
     * that are {@code void} values.
     */
    VOID_VALUE;
}
