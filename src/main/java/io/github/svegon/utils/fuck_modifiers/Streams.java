...
public final class Streams {
    ...
    /**
     * An {@code ints} range spliterator.
     */
    ...
    /**
     * A {@code longs} range spliterator.
     *
    ...
    public static final class StreamBuilderImpl<T>
    ...
    public static final class IntStreamBuilderImpl extends AbstractStreamBuilderImpl<Integer, Spliterator.OfInt>
    ...
    public static final class DoubleStreamBuilderImpl
    ...
    public abstract static class ConcatSpliterator<T, T_SPLITR extends Spliterator<T>> implements Spliterator<T> {
        ...
        private abstract static class OfPrimitive<T, T_CONS, T_SPLITR extends Spliterator.OfPrimitive<T, T_CONS,
        ...
        public static class OfBoolean extends OfPrimitive<Boolean, BooleanConsumer, BooleanSpliterator>
                implements BooleanSpliterator {
            public OfBoolean(BooleanSpliterator aSpliterator, BooleanSpliterator bSpliterator) {
                super(aSpliterator, bSpliterator);
            }
        ...
        public static class OfByte extends OfPrimitive<Byte, ByteConsumer, ByteSpliterator>
                implements ByteSpliterator {
            public OfByte(ByteSpliterator aSpliterator, ByteSpliterator bSpliterator) {
                super(aSpliterator, bSpliterator);
            }
        ...
        public static class OfShort extends OfPrimitive<Short, ShortConsumer, ShortSpliterator>
                implements ShortSpliterator {
            public OfShort(ShortSpliterator aSpliterator, ShortSpliterator bSpliterator) {
                super(aSpliterator, bSpliterator);
            }
        ...
        public static class OfInt extends OfPrimitive<Integer, IntConsumer, Spliterator.OfInt>
        ...
        public static class OfChar extends OfPrimitive<Character, CharConsumer, CharSpliterator>
                implements CharSpliterator {
            public OfChar(CharSpliterator aSpliterator, CharSpliterator bSpliterator) {
                super(aSpliterator, bSpliterator);
            }
        ...
        public static class OfFloat extends OfPrimitive<Float, FloatConsumer, FloatSpliterator>
                implements FloatSpliterator {
            public OfFloat(FloatSpliterator aSpliterator,
                           FloatSpliterator bSpliterator) {
                super(aSpliterator, bSpliterator);
            }
        ...
        public static class OfDouble extends OfPrimitive<Double, DoubleConsumer, Spliterator.OfDouble>
     ...
     * any exceptions thrown by the second as suppressed exceptions of the first.
     */
    public static Runnable composedClose(final BaseStream<?, ?> a, final BaseStream<?, ?> b) {
        return () -> {
            try {
                a.close();
            } catch (Throwable e1) {
