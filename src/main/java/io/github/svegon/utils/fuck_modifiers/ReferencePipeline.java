...
public abstract class ReferencePipeline<P_IN, P_OUT>
     ...
     *        {@link io.github.svegon.utils.fuck_modifiers.StreamOpFlag}
    ...
    @Override
    public final <P_IN> io.github.svegon.utils.fuck_modifiers.Node<P_OUT> evaluateToNode(PipelineHelper<P_OUT> helper,
                                                                                         Spliterator<P_IN> spliterator,
                                                                                         boolean flattenTree,
                                                                                         IntFunction<P_OUT[]> generator) {
        return io.github.svegon.utils.fuck_modifiers.Nodes.collect(helper, spliterator, flattenTree, generator);
    }
    ...
    @Override
    public final io.github.svegon.utils.fuck_modifiers.Node.Builder<P_OUT> makeNodeBuilder(long exactSizeIfKnown, IntFunction<P_OUT[]> generator) {
        return io.github.svegon.utils.fuck_modifiers.Nodes.builder(exactSizeIfKnown, generator);
    }
    ...
    public Stream<P_OUT> unordered() {
        ...
        return new StatelessOp<>(this, StreamShape.REFERENCE, io.github.svegon.utils.fuck_modifiers.StreamOpFlag.NOT_ORDERED) {
            @Override
    ...
    public final Stream<P_OUT> filter(Predicate<? super P_OUT> predicate) {
        ...
        return new StatelessOp<P_OUT, P_OUT>(this, StreamShape.REFERENCE,
                                     io.github.svegon.utils.fuck_modifiers.StreamOpFlag.NOT_SIZED) {
            @Override
            public Sink<P_OUT> opWrapSink(int flags, Sink<P_OUT> sink) {
    ...
    public final <R> Stream<R> map(Function<? super P_OUT, ? extends R> mapper) {
        ...
        return new StatelessOp<P_OUT, R>(this, StreamShape.REFERENCE,
                                     io.github.svegon.utils.fuck_modifiers.StreamOpFlag.NOT_SORTED | io.github.svegon.utils.fuck_modifiers.StreamOpFlag.NOT_DISTINCT) {
            @Override
    ...
    public final <R> Stream<R> flatMap(Function<? super P_OUT, ? extends Stream<? extends R>> mapper) {
        Objects.requireNonNull(mapper);
        return new StatelessOp<P_OUT, R>(this, StreamShape.REFERENCE,
                                     io.github.svegon.utils.fuck_modifiers.StreamOpFlag.NOT_SORTED | io.github.svegon.utils.fuck_modifiers.StreamOpFlag.NOT_DISTINCT | io.github.svegon.utils.fuck_modifiers.StreamOpFlag.NOT_SIZED) {
            @Override
            public Sink<P_OUT> opWrapSink(int flags, Sink<R> sink) {
                return new Sink.ChainedReference<P_OUT, R>(sink) {
    ...
    public void forEach(Consumer<? super P_OUT> action) {
        evaluate(io.github.svegon.utils.fuck_modifiers.ForEachOps.makeRef(action, false));
    }

    @Override
    public void forEachOrdered(Consumer<? super P_OUT> action) {
        evaluate(io.github.svegon.utils.fuck_modifiers.ForEachOps.makeRef(action, true));
    }
    ...
    public final <A> A[] toArray(IntFunction<A[]> generator) {
        ...
        return (A[]) io.github.svegon.utils.fuck_modifiers.Nodes.flatten(evaluateToArrayNode(rawGenerator), rawGenerator)
    ...
    public static class Head<E_IN, E_OUT> extends ReferencePipeline<E_IN, E_OUT> {
         ...
         *                    in {@link io.github.svegon.utils.fuck_modifiers.StreamOpFlag}
         */
    ...
    public abstract static class StatefulOp<E_IN, E_OUT>
        ...
        @Override
        public abstract <P_IN> io.github.svegon.utils.fuck_modifiers.Node<E_OUT> opEvaluateParallel(PipelineHelper<E_OUT> helper,
                                                                                                    Spliterator<P_IN> spliterator,
