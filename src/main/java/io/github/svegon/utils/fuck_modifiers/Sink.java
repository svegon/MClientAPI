 ...
 *
 * <pre>{@code
 *     ints longestStringLengthStartingWithA
 *         = strings.stream()
 ...
 * points for {@code accept(Object)}, {@code accept(ints)}, etc, so that we do
 ...
 * must call the {@code accept(ints)} method when emitting values to the downstream.
 * The {@code accept()} method applies the mapping function from {@code U} to
 * {@code ints} and passes the resulting value to the downstream {@code Sink}.
 *
...
public interface Sink<T> extends Consumer<T> {
    ...
    /**
     * Accepts an ints value.
     *
     * @implSpec The default implementation throws IllegalStateException.
     *
     * @throws IllegalStateException if this sink does not accept ints values
     */
    ...
    /**
     * Accepts a longs value.
     *
     * @implSpec The default implementation throws IllegalStateException.
     *
     * @throws IllegalStateException if this sink does not accept longs values
     */
    ...
    /**
     * Accepts a doubles value.
     *
     * @implSpec The default implementation throws IllegalStateException.
     *
     * @throws IllegalStateException if this sink does not accept doubles values
     */
     ...
     * {@code accept(ints)}, and wires {@code accept(Integer)} to bridge to
     * {@code accept(ints)}.
     */
     ...
     * {@code accept(longs)}, and wires {@code accept(Long)} to bridge to
     * {@code accept(longs)}.
     */
     ...
     * {@code accept(doubles)}, and wires {@code accept(Double)} to bridge to
     * {@code accept(doubles)}.
     */
