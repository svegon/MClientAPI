...
public final class ShortForkTable<V, E extends ShortForkTable.Entry<V, E>>
    ...
    public ShortForkTable(int branchFactor, @Nullable ShortHash.Strategy strategy) {
        super(branchFactor);
        this.strategy = strategy != null ? strategy : HashUtil.defaultShortStrategy();
    }

    public ShortForkTable(@Nullable ShortHash.Strategy strategy) {
        this(DEFAULT_BRANCH_FACTOR, strategy);
    }

    public ShortForkTable(int branchFactor) {
        this(branchFactor, null);
    }

    public ShortForkTable() {
        this(null);
    }
    ...
    public E put(final @NotNull E entry) {
        ...
        while (itr.hasNext()) {
            ...
            if (entry0.hash == entry.hash && strategy.equals(key, entry0.getShortKey())) {
                itr.set(entry);
                return entry0;
            }
        }
    ...
    public static abstract class Entry<V, E extends Entry<V, E>> implements Short2ObjectMap.Entry<V> {
        final ShortForkTable<V, E> table;
        final short key;
        protected final int hash;

        protected Entry(ShortForkTable<V, E> table, short key) {
            this.table = table;
            this.key = key;
    ...
    private static final class Short2EntryEntry<V, E extends Entry<V, E>>
            extends AbstractForkTable.Key2EntryEntry<Short, V, E> implements Short2ObjectMap.Entry<E> {
        private final ShortForkTable<V, E> ref;

        public Short2EntryEntry(ShortForkTable<V, E> ref, E entry) {
            super(entry);
            this.ref = ref;
        }
    ...
    private static final class KeySet<V, E extends Entry<V, E>> extends AbstractShortSet {
        ...
        private KeySet(ShortForkTable<V, E> ref) {
            this.ref = ref;
        }
    ...
    private static final class EntrySet<V, E extends Entry<V, E>> extends AbstractObjectSet<Short2ObjectMap.Entry<E>> {
        ...
        private EntrySet(ShortForkTable<V, E> ref) {
            this.ref = ref;
        }
