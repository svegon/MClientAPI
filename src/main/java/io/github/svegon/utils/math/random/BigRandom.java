...
public interface BigRandom extends RandomGenerator {
    ...
    default IntStream bytes() {
        return IntStream.generate(this::nextByte).sequential();
    }
     ...
     */
    default IntStream bytes(byte randomNumberOrigin, byte randomNumberBound) {
        if (randomNumberOrigin >= randomNumberBound) {
            throw new IllegalArgumentException("bound must be greater than origin");
        }

        return IntStream.generate(() -> nextByte(randomNumberOrigin, randomNumberBound)).sequential();
    }
     ...
     * that repeatedly calls {@link BigRandom#nextByte() nextByte}().
     */
    default IntStream bytes(long streamSize) {
     ...
     * calls {@link BigRandom#nextByte(byte, byte) nextByte}(randomNumberOrigin, randomNumberBound).
     */
    default IntStream bytes(long streamSize, byte randomNumberOrigin,
    ...
    default IntStream chars() {
        return IntStream.generate(this::nextChar).sequential();
    }
     ...
     */
    default IntStream chars(char randomNumberOrigin, char randomNumberBound) {
        if (randomNumberOrigin >= randomNumberBound) {
            throw new IllegalArgumentException("bound must be greater than origin");
        }

        return IntStream.generate(() -> nextChar(randomNumberOrigin, randomNumberBound)).sequential();
    }
     ...
     * that repeatedly calls {@link BigRandom#nextChar() nextChar}().
     */
    default IntStream chars(long streamSize) {
        checkStreamSize(streamSize);
     ...
     * calls {@link BigRandom#nextChar(char, char) nextChar}(randomNumberOrigin, randomNumberBound).
     */
    default IntStream chars(long streamSize, char randomNumberOrigin,
     ...
     */
    default IntStream shorts() {
        return IntStream.generate(this::nextShort).sequential();
    }
     ...
     */
    default IntStream shorts(short randomNumberOrigin, short randomNumberBound) {
        if (randomNumberOrigin >= randomNumberBound) {
            throw new IllegalArgumentException("bound must be greater than origin");
        }

        return IntStream.generate(() -> nextShort(randomNumberOrigin, randomNumberBound)).sequential();
    }
     ...
     * that repeatedly calls {@link BigRandom#nextShort() nextShort}().
     */
    default IntStream shorts(long streamSize) {
        checkStreamSize(streamSize);
     ...
     * calls {@link BigRandom#nextShort(short, short) nextShort}(randomNumberOrigin, randomNumberBound).
     */
    default IntStream shorts(long streamSize, short randomNumberOrigin,
    ...
    default DoubleStream floats() {
        return DoubleStream.generate(this::nextFloat).sequential();
    }
     ...
     */
    default DoubleStream floats(float randomNumberOrigin, float randomNumberBound) {
        if (!(randomNumberOrigin < randomNumberBound && (randomNumberBound - randomNumberOrigin)
                < Float.POSITIVE_INFINITY)) {
            throw new IllegalArgumentException("bound must be greater than origin");
        }

        return DoubleStream.generate(() -> nextFloat(randomNumberOrigin, randomNumberBound)).sequential();
    }
     ...
     */
    default DoubleStream floats(long streamSize) {
        if (streamSize < 0L) {
     ...
     * calls {@link RandomGenerator#nextFloat(float, float)  nextDouble}(randomNumberOrigin, randomNumberBound).
     */
    default DoubleStream floats(long streamSize, float randomNumberOrigin,
