...
public interface S2CPlayPacketListener extends ClientPlayPacketListener {
    ...
    @Override
    default void onPingResult(PingResultS2CPacket packet) {

    }

    @Override
    default void onPing(CommonPingS2CPacket packet) {
    ...
    @Override
    default void onEnterReconfiguration(EnterReconfigurationS2CPacket packet) {

    }

    @Override
    default void onStartChunkSend(StartChunkSendS2CPacket packet) {

    }

    @Override
    default void onChunkSent(ChunkSentS2CPacket packet) {
