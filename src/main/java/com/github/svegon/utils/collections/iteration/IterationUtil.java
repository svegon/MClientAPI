...
import com.github.svegon.utils.fast.util.booleans.OnNextComputeBooleanIterator;
import com.github.svegon.utils.fast.util.bytes.OnNextComputeByteIterator;
import com.github.svegon.utils.fast.util.bytes.transform.bytes.B2BTransformingIterator;
import com.github.svegon.utils.fast.util.bytes.transform.chars.C2BTransformingIterator;
import com.github.svegon.utils.fast.util.bytes.transform.objects.L2BTransformingIterator;
import com.github.svegon.utils.fast.util.bytes.transform.shorts.S2BTransformingIterator;
import com.github.svegon.utils.fast.util.chars.OnNextComputeCharIterator;
import com.github.svegon.utils.fast.util.chars.transform.booleans.Z2CTransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.chars.transform.booleans.Z2CTransformingIterator;
import com.github.svegon.utils.fast.util.chars.transform.booleans.Z2CTransformingListIterator;
import com.github.svegon.utils.fast.util.chars.transform.bytes.B2CTransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.chars.transform.bytes.B2CTransformingIterator;
import com.github.svegon.utils.fast.util.chars.transform.bytes.B2CTransformingListIterator;
import com.github.svegon.utils.fast.util.chars.transform.chars.C2CTransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.chars.transform.chars.C2CTransformingIterator;
import com.github.svegon.utils.fast.util.chars.transform.chars.C2CTransformingListIterator;
import com.github.svegon.utils.fast.util.chars.transform.ints.I2CTransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.chars.transform.ints.I2CTransformingIterator;
import com.github.svegon.utils.fast.util.chars.transform.ints.I2CTransformingListIterator;
import com.github.svegon.utils.fast.util.chars.transform.objects.L2CTransformingIterator;
import com.github.svegon.utils.fast.util.chars.transform.objects.L2CTransformingListIterator;
import com.github.svegon.utils.fast.util.chars.transform.shorts.S2CTransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.chars.transform.shorts.S2CTransformingIterator;
import com.github.svegon.utils.fast.util.chars.transform.shorts.S2CTransformingListIterator;
import com.github.svegon.utils.fast.util.doubles.OnNextComputeDoubleIterator;
import com.github.svegon.utils.fast.util.floats.OnNextComputeFloatIterator;
import com.github.svegon.utils.fast.util.ints.OnNextComputeIntIterator;
import com.github.svegon.utils.fast.util.ints.transform.booleans.Z2ITransformingIterator;
import com.github.svegon.utils.fast.util.ints.transform.bytes.B2ITransformingIterator;
import com.github.svegon.utils.fast.util.ints.transform.chars.C2ITransformingIterator;
import com.github.svegon.utils.fast.util.ints.transform.ints.I2ITransformingIterator;
import com.github.svegon.utils.fast.util.ints.transform.objects.L2ITransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.ints.transform.objects.L2ITransformingIterator;
import com.github.svegon.utils.fast.util.ints.transform.objects.L2ITransformingListIterator;
import com.github.svegon.utils.fast.util.ints.transform.shorts.S2ITransformingIterator;
import com.github.svegon.utils.fast.util.longs.OnNextComputeLongIterator;
import com.github.svegon.utils.fast.util.objects.OnNextComputeObjectIterator;
import com.github.svegon.utils.fast.util.objects.transform.booleans.Z2LTransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.objects.transform.booleans.Z2LTransformingIterator;
import com.github.svegon.utils.fast.util.objects.transform.booleans.Z2LTransformingListIterator;
import com.github.svegon.utils.fast.util.objects.transform.bytes.B2LTransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.objects.transform.bytes.B2LTransformingIterator;
import com.github.svegon.utils.fast.util.objects.transform.bytes.B2LTransformingListIterator;
import com.github.svegon.utils.fast.util.objects.transform.chars.C2LTransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.objects.transform.chars.C2LTransformingIterator;
import com.github.svegon.utils.fast.util.objects.transform.chars.C2LTransformingListIterator;
import com.github.svegon.utils.fast.util.objects.transform.ints.I2LTransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.objects.transform.ints.I2LTransformingIterator;
import com.github.svegon.utils.fast.util.objects.transform.ints.I2LTransformingListIterator;
import com.github.svegon.utils.fast.util.objects.transform.objects.L2LTransformingIterator;
import com.github.svegon.utils.fast.util.objects.transform.objects.L2LTransformingListIterator;
import com.github.svegon.utils.fast.util.objects.transform.shorts.S2LTransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.objects.transform.shorts.S2LTransformingIterator;
import com.github.svegon.utils.fast.util.objects.transform.shorts.S2LTransformingListIterator;
import com.github.svegon.utils.fast.util.shorts.OnNextComputeShortIterator;
import com.github.svegon.utils.fast.util.shorts.transform.booleans.Z2STransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.shorts.transform.booleans.Z2STransformingIterator;
import com.github.svegon.utils.fast.util.shorts.transform.booleans.Z2STransformingListIterator;
import com.github.svegon.utils.fast.util.shorts.transform.bytes.B2STransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.shorts.transform.bytes.B2STransformingIterator;
import com.github.svegon.utils.fast.util.shorts.transform.bytes.B2STransformingListIterator;
import com.github.svegon.utils.fast.util.shorts.transform.chars.C2STransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.shorts.transform.chars.C2STransformingIterator;
import com.github.svegon.utils.fast.util.shorts.transform.chars.C2STransformingListIterator;
import com.github.svegon.utils.fast.util.shorts.transform.ints.I2STransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.shorts.transform.ints.I2STransformingIterator;
import com.github.svegon.utils.fast.util.shorts.transform.ints.I2STransformingListIterator;
import com.github.svegon.utils.fast.util.shorts.transform.objects.L2STransformingIterator;
import com.github.svegon.utils.fast.util.shorts.transform.shorts.S2STransformingBidirectionalIterator;
import com.github.svegon.utils.fast.util.shorts.transform.shorts.S2STransformingIterator;
import com.github.svegon.utils.fast.util.shorts.transform.shorts.S2STransformingListIterator;
