...
import com.github.svegon.utils.fast.util.booleans.transform.bytes.B2ZRATransformingList;
import com.github.svegon.utils.fast.util.booleans.transform.bytes.B2ZTransformingList;
import com.github.svegon.utils.fast.util.booleans.transform.objects.L2ZRATransformingList;
import com.github.svegon.utils.fast.util.booleans.transform.objects.L2ZTransformingList;
import com.github.svegon.utils.fast.util.chars.transform.objects.L2CRATransformingList;
import com.github.svegon.utils.fast.util.chars.transform.objects.L2CTransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.booleans.Z2DRATransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.booleans.Z2DTransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.bytes.B2DRATransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.bytes.B2DTransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.chars.C2DRATransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.chars.C2DTransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.doubles.D2DRATransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.doubles.D2DTransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.floats.F2DRATransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.floats.F2DTransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.ints.I2DRATransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.ints.I2DTransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.longs.J2DRATransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.longs.J2DTransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.objects.L2DRATransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.objects.L2DTransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.shorts.S2DRATransformingList;
import com.github.svegon.utils.fast.util.doubles.transform.shorts.S2DTransformingList;
import com.github.svegon.utils.fast.util.floats.transform.booleans.Z2FRATransformingList;
import com.github.svegon.utils.fast.util.floats.transform.booleans.Z2FTransformingList;
import com.github.svegon.utils.fast.util.floats.transform.bytes.B2FRATransformingList;
import com.github.svegon.utils.fast.util.floats.transform.bytes.B2FTransformingList;
import com.github.svegon.utils.fast.util.floats.transform.chars.C2FRATransformingList;
import com.github.svegon.utils.fast.util.floats.transform.chars.C2FTransformingList;
import com.github.svegon.utils.fast.util.floats.transform.doubles.D2FRATransformingList;
import com.github.svegon.utils.fast.util.floats.transform.doubles.D2FTransformingList;
import com.github.svegon.utils.fast.util.floats.transform.floats.F2FRATransformingList;
import com.github.svegon.utils.fast.util.floats.transform.floats.F2FTransformingList;
import com.github.svegon.utils.fast.util.floats.transform.ints.I2FRATransformingList;
import com.github.svegon.utils.fast.util.floats.transform.ints.I2FTransformingList;
import com.github.svegon.utils.fast.util.floats.transform.longs.J2FRATransformingList;
import com.github.svegon.utils.fast.util.floats.transform.longs.J2FTransformingList;
import com.github.svegon.utils.fast.util.floats.transform.objects.L2FRATransformingList;
import com.github.svegon.utils.fast.util.floats.transform.objects.L2FTransformingList;
import com.github.svegon.utils.fast.util.floats.transform.shorts.S2FRATransformingList;
import com.github.svegon.utils.fast.util.floats.transform.shorts.S2FTransformingList;
import com.github.svegon.utils.fast.util.ints.transform.booleans.Z2IRATransformingList;
import com.github.svegon.utils.fast.util.ints.transform.booleans.Z2ITransformingList;
import com.github.svegon.utils.fast.util.ints.transform.bytes.B2IRATransformingList;
import com.github.svegon.utils.fast.util.ints.transform.bytes.B2ITransformingList;
import com.github.svegon.utils.fast.util.ints.transform.doubles.D2IRATransformingList;
import com.github.svegon.utils.fast.util.ints.transform.doubles.D2ITransformingList;
import com.github.svegon.utils.fast.util.ints.transform.ints.I2IRATranformingList;
import com.github.svegon.utils.fast.util.ints.transform.ints.I2ITransformingList;
import com.github.svegon.utils.fast.util.ints.transform.longs.J2IRATranformingList;
import com.github.svegon.utils.fast.util.ints.transform.longs.J2ITransformingList;
import com.github.svegon.utils.fast.util.ints.transform.objects.L2IRATransformingList;
import com.github.svegon.utils.fast.util.ints.transform.objects.L2ITransformingList;
import com.github.svegon.utils.fast.util.longs.transform.doubles.D2JRATransformingList;
import com.github.svegon.utils.fast.util.longs.transform.doubles.D2JTransformingList;
import com.github.svegon.utils.fast.util.longs.transform.objects.L2JRATransformingList;
import com.github.svegon.utils.fast.util.longs.transform.objects.L2JTransformingList;
import com.github.svegon.utils.fast.util.objects.OnNextComputeObjectIterator;
import com.github.svegon.utils.fast.util.shorts.transform.objects.L2SRATransformingList;
import com.github.svegon.utils.fast.util.shorts.transform.objects.L2STransformingList;
...
import com.github.svegon.utils.fast.util.bytes.transform.objects.L2BRATransformingList;
import com.github.svegon.utils.fast.util.bytes.transform.objects.L2BTransformingList;
