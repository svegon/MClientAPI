...
import com.github.svegon.utils.fast.util.floats.FloatCollector;
...
import com.github.svegon.utils.optional.OptionalFloat;
...
public interface FloatStream extends BaseStream<Float, FloatStream> {
     ...
     * @return the new stream
     */
    <U> Stream<U> mapToObj(Float2ObjectFunction<? extends U> mapper);
     ...
     * @return the new stream
     */
    BooleanStream mapToBoolean(FloatPredicate mapper);
     ...
     * @return the new stream
     */
    ByteStream mapToByte(Float2ByteFunction mapper);
     ...
     * @return the new stream
     */
    ShortStream mapToShort(Float2ShortFunction mapper);
     ...
     * @return the new stream
     */
    IntStream mapToInt(Float2IntFunction mapper);
     ...
     * @return the new stream
     */
    LongStream mapToLong(Float2LongFunction mapper);
     ...
     * @return the new stream
     */
    CharStream mapToChar(Float2CharFunction mapper);
     ...
     * @return the new stream
     */
    DoubleStream mapToDouble(Float2DoubleFunction mapper);
     ...
     */
    FloatStream flatMap(Float2ObjectFunction<? extends FloatStream> mapper);
     ...
     * stream source (such as {@link #generate(FloatSupplier)}) or removing the
     ...
     * {@link #generate(FloatSupplier)}) or removing the ordering constraint
     ...
     * @since 9
     */
    default FloatStream takeWhile(FloatPredicate predicate) {
        Objects.requireNonNull(predicate);
        // Reuses the unordered spliterator, which, when encounter is present,
        // is safe to use as longs as it configured not to split
        return StreamUtil.floatStream(
                new WhileOps.UnorderedWhileSpliterator.OfFloat.Taking(spliterator(), true, predicate),
     ...
     * @since 9
     */
    default FloatStream dropWhile(FloatPredicate predicate) {
        Objects.requireNonNull(predicate);
        // Reuses the unordered spliterator, which, when encounter is present,
        // is safe to use as longs as it configured not to split
        return StreamUtil.floatStream(new WhileOps.UnorderedWhileSpliterator.OfFloat.Dropping(spliterator(),
     ...
     * <pre>{@code
     *     FloatStream s = FloatStream.of(1, 2, 3, 4);
    ...
    /**
     * Returns a {@code FloatSummaryStatistics} describing various summary data
     ...
     * operation</a>.
     *
     * @return a {@code FloatSummaryStatistics} describing various summary data
    ...
    /**
     * Returns a builder for a {@code FloatStream}.
     *
    ...
    /**
     * Returns an empty sequential {@code FloatStream}.
     *
     * @return an empty sequential stream
     */
    static FloatStream empty() {
        return StreamUtil.floatStream(SpliteratorUtil.emptyFloatSpliterator(), false);
    }

    /**
     * Returns a sequential {@code FloatStream} containing a single element.
     *
     * @param t the single element
     * @return a singleton sequential stream
     */
    static FloatStream of(float t) {
        return StreamUtil.floatStream(new Builder(t), false);
    }
     ...
     * @return the new stream
     */
    static FloatStream of(float... values) {
        return ArrayUtil.stream(values);
    }

    /**
     * Returns an infinite sequential ordered {@code FloatStream} produced by iterative
     * application of a function {@code f} to an initial element {@code seed},
     * producing a {@code Stream} consisting of {@code seed}, {@code f(seed)},
     * {@code f(f(seed))}, etc.
     *
     * <p>The first element (position {@code 0}) in the {@code FloatStream}
     ...
     *          a new element
     * @return a new sequential {@code FloatStream}
     */
    static FloatStream iterate(final float seed, final Float2FloatFunction f) {
        Objects.requireNonNull(f);
        FloatSpliterator spliterator = new SpliteratorUtil.FloatSpliteratorImpl(Long.MAX_VALUE,
    ...
    /**
     * Returns a sequential ordered {@code FloatStream} produced by iterative
     * application of the given {@code next} function to an initial element,
     * conditioned on satisfying the given {@code hasNext} predicate.  The
     * stream terminates as soon as the {@code hasNext} predicate returns false.
     *
     * <p>{@code FloatStream.iterate} should produce the same sequence of elements as
     * produced by the corresponding for-loop:
     * <pre>{@code
     *     for (Float index=seed; hasNext.test(index); index = next.applyAsFloat(index)) {
     *         ...
     *     }
     * }</pre>
     *
     ...
     * @since 9
     */
    static FloatStream iterate(Float seed, FloatPredicate hasNext, Float2FloatFunction next) {
        ...
        FloatSpliterator spliterator = new SpliteratorUtil.FloatSpliteratorImpl(Long.MAX_VALUE,
            ...
            public void forEachRemaining(FloatConsumer action) {
                ...
                if (finished)
                    return;
                finished = true;
                float t = started ? next.apply(prev) : seed;
     ...
     * generated by the provided {@code FloatSupplier}.  This is suitable for
     * generating constant streams, streams of random elements, etc.
     *
     * @param s the {@code FloatSupplier} for generated elements
     * @return a new infinite sequential unordered {@code FloatStream}
     */
    static FloatStream generate(FloatSupplier s) {
        Objects.requireNonNull(s);
        return StreamUtil.floatStream(new StreamSpliterators.InfiniteSupplyingSpliterator.OfFloat(Long.MAX_VALUE, s),
                false);
    }
     ...
     * <pre>{@code
     *     FloatStream concat = Stream.of(s1, s2, s3, s4).flatMapToFloat(s -> s);
     * }</pre>
     *
     ...
     */
    static FloatStream concat(FloatStream a, FloatStream b) {
        Objects.requireNonNull(a);
        Objects.requireNonNull(b);

        FloatSpliterator split = new Streams.ConcatSpliterator.OfFloat(a.spliterator(), b.spliterator());
        FloatStream stream = StreamUtil.floatStream(split, a.isParallel() || b.isParallel());
        return stream.onClose(Streams.composedClose(a, b));
    }

    /**
     * A mutable builder for a {@code FloatStream}.
     *
     ...
     *
     * @see FloatStream#builder()
     * @since 1.8
     */
    final class Builder implements FloatConsumer, FloatSpliterator {
        ...
        public FloatStream build() {
            ...
            if (c >= 0) {
                ...
                return (c < 2) ? StreamUtil.floatStream(this, false)
                        : StreamUtil.floatStream(buffer.spliterator(), false);
            }
