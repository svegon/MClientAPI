...
import com.github.svegon.utils.fast.util.bytes.ByteCollector;
...
public interface ByteStream extends BaseStream<Byte, ByteStream> {
     ...
     * @return the new stream
     */
    <U> Stream<U> mapToObj(Byte2ObjectFunction<? extends U> mapper);
     ...
     * @return the new stream
     */
    BooleanStream mapToBoolean(BytePredicate mapper);
     ...
     * @return the new stream
     */
    ShortStream mapToShort(Byte2ShortFunction mapper);
     ...
     * @return the new stream
     */
    IntStream mapToInt(Byte2IntFunction mapper);
     ...
     * @return the new stream
     */
    LongStream mapToLong(Byte2LongFunction mapper);
     ...
     * @return the new stream
     */
    CharStream mapToChar(Byte2CharFunction mapper);
     ...
     * @return the new stream
     */
    FloatStream mapToFloat(Byte2FloatFunction mapper);
     ...
     * @return the new stream
     */
    DoubleStream mapToDouble(Byte2DoubleFunction mapper);
     ...
     */
    ByteStream flatMap(Byte2ObjectFunction<? extends ByteStream> mapper);
     ...
     * production of some or all the elements (such as with bytes-circuiting
     ...
     *
     * <p>This is a <a href="package-summary.html#StreamOps">bytes-circuiting
     ...
     * stream source (such as {@link #generate(ByteSupplier)}) or removing the
     ...
     * byteacteristics of this stream (namely parallel or sequential execution
     ...
     * {@link #generate(ByteSupplier)}) or removing the ordering constraint
     ...
     * @since 9
     */
    default ByteStream takeWhile(BytePredicate predicate) {
        Objects.requireNonNull(predicate);
        // Reuses the unordered spliterator, which, when encounter is present,
        // is safe to use as longs as it configured not to split
        return StreamUtil.byteStream(new WhileOps.UnorderedWhileSpliterator.OfByte.Taking(spliterator(), true,
     ...
     * @since 9
     */
    default ByteStream dropWhile(BytePredicate predicate) {
        Objects.requireNonNull(predicate);
        // Reuses the unordered spliterator, which, when encounter is present,
        // is safe to use as longs as it configured not to split
        return StreamUtil.byteStream(new WhileOps.UnorderedWhileSpliterator.OfByte.Dropping(spliterator(),
     ...
     * <pre>{@code
     *     Byte sum = numbers.reduce(0, (a, b) -> a+b);
     * }</pre>
     *
     * or more compactly:
     *
     * <pre>{@code
     *     Byte sum = numbers.reduce(0, Byte::sum);
     * }</pre>
     *
     ...
     * function, and returns an {@code OptionalByte} describing the reduced
     ...
     * }</pre>
     *
     * <p>Like {@link #reduce(byte, ByteBinaryOperator)}, {@code collect}
     ...
     */
    <R> R collect(Supplier<R> supplier, ObjectByteConsumer<R> accumulator, BiConsumer<R, R> combiner);
     ...
     * {@link #collect(Supplier, ObjectByteConsumer, BiConsumer)}, allowing for reuse of
     ...
     * <pre>{@code
     *     ByteList asList = byteStream.collect(CollectingUtil.toByteList());
     * }</pre>
     *
     ...
     * @return the result of the reduction
     * @see #collect(Supplier, ObjectByteConsumer, BiConsumer)
     * @see Collectors
     */
    <R, A> R collect(ByteCollector<A, R> collector);
     ...
     * Byteing-point summation were exact, this method would be
     * equivalent to:
     *
     * <pre>{@code
     *     return reduce(0, Byte::sum);
     * }</pre>
     *
     * In particular, this method may be implemented using compensated
     * summation or other technique to reduce the error bound in the
     * numerical sum compared to a simple summation of {@code Byte}
     * values.
     *
     ...
     * stream, or an empty OptionalByte if this stream is empty.  The minimum
     * element will be {@code Byte.NaN} if any stream element was NaN. Unlike
     * the numerical comparison operators, this method considers negative zero
     * to be strictly smaller than positive zero. This is a special case of a
     * <a href="package-summary.html#Reduction">reduction</a> and is
     * equivalent to:
     * <pre>{@code
     *     return reduce(Byte::min);
     * }</pre>
     *
     * <p>This is a <a href="package-summary.html#StreamOps">terminal
     * operation</a>.
     ...
     * stream, or an empty OptionalByte if this stream is empty.  The maximum
     * element will be {@code Byte.NaN} if any stream element was NaN. Unlike
     * the numerical comparison operators, this method considers negative zero
     ...
     * <pre>{@code
     *     ByteStream s = ByteStream.of(1, 2, 3, 4);
    ...
    /**
     * Returns an {@code OptionalByte} describing the arithmetic
     ...
     * to yield more accurate results.
     *
     * @return an {@code OptionalByte} containing the average element of this
     * stream, or an empty optional if the stream is empty
     */
    OptionalDouble average();

    /**
     * Returns a {@code ByteSummaryStatistics} describing various summary data
     ...
     * operation</a>.
     *
     * @return a {@code ByteSummaryStatistics} describing various summary data
     ...
     * stream, or an empty {@code OptionalByte} if the stream is empty.  If
     * the stream has no encounter order, then any element may be returned.
     *
     * <p>This is a <a href="package-summary.html#StreamOps">bytes-circuiting
     * terminal operation</a>.
     *
     * @return an {@code OptionalByte} describing the first element of this
     * stream, or an empty {@code OptionalByte} if the stream is empty
     */
    OptionalByte findFirst();

    /**
     * Returns an {@link OptionalByte} describing some element of the stream,
     ...
     *
     * @return an {@code OptionalByte} describing some element of this stream,
     * or an empty {@code OptionalByte} if the stream is empty
     * @see #findFirst()
     */
     ...
     * each boxed to a {@code Byte}
     */
    default Stream<Byte> boxed() {
        return mapToObj(c -> c);
    }
    ...
    /**
     * Returns a builder for a {@code ByteStream}.
     *
    ...
    /**
     * Returns an empty sequential {@code ByteStream}.
     *
     * @return an empty sequential stream
     */
    static ByteStream empty() {
        return StreamUtil.byteStream(SpliteratorUtil.emptyByteSpliterator(), false);
    }

    /**
     * Returns a sequential {@code ByteStream} containing a single element.
     *
     * @param t the single element
     * @return a singleton sequential stream
     */
    static ByteStream of(byte t) {
        return StreamUtil.byteStream(ByteSpliterators.singleton(t), false);
    }
     ...
     * @return the new stream
     */
    static ByteStream of(byte... values) {
        return ArrayUtil.stream(values);
    }

    /**
     * Returns an infinite sequential ordered {@code ByteStream} produced by iterative
     * application of a function {@code f} to an initial element {@code seed},
     * producing a {@code Stream} consisting of {@code seed}, {@code f(seed)},
     * {@code f(f(seed))}, etc.
     *
     * <p>The first element (position {@code 0}) in the {@code ByteStream}
     ...
     *          a new element
     * @return a new sequential {@code ByteStream}
     */
    static ByteStream iterate(final byte seed, final ByteUnaryOperator f) {
        Objects.requireNonNull(f);

        return StreamUtil.byteStream(new SpliteratorUtil.ByteSpliteratorImpl(Long.MAX_VALUE,
    ...
    /**
     * Returns a sequential ordered {@code ByteStream} produced by iterative
     * application of the given {@code next} function to an initial element,
     * conditioned on satisfying the given {@code hasNext} predicate.  The
     * stream terminates as soon as the {@code hasNext} predicate returns false.
     *
     * <p>{@code ByteStream.iterate} should produce the same sequence of elements as
     * produced by the corresponding for-loop:
     * <pre>{@code
     *     for (Byte index=seed; hasNext.test(index); index = next.applyAsByte(index)) {
     *         ...
     *     }
     * }</pre>
     *
     ...
     * @since 9
     */
    static ByteStream iterate(final byte seed, final BytePredicate hasNext, final ByteUnaryOperator next) {
        ...
        return StreamUtil.byteStream(new SpliteratorUtil.ByteSpliteratorImpl(Long.MAX_VALUE,
            ...
            public void forEachRemaining(ByteConsumer action) {
                ...
                finished = true;
                byte t = started ? next.apply(prev) : seed;
     ...
     * generated by the provided {@code ByteSupplier}.  This is suitable for
     * generating constant streams, streams of random elements, etc.
     *
     * @param s the {@code ByteSupplier} for generated elements
     * @return a new infinite sequential unordered {@code ByteStream}
     */
    static ByteStream generate(ByteSupplier s) {
        Objects.requireNonNull(s);
        return StreamUtil.byteStream(new StreamSpliterators.InfiniteSupplyingSpliterator.OfByte(Long.MAX_VALUE, s),
                false);
    }
     ...
     * <pre>{@code
     *     ByteStream concat = Stream.of(s1, s2, s3, s4).flatMapToByte(s -> s);
     * }</pre>
     *
     ...
     */
    static ByteStream concat(ByteStream a, ByteStream b) {
        Objects.requireNonNull(a);
        Objects.requireNonNull(b);

        ByteSpliterator split = new Streams.ConcatSpliterator.OfByte(a.spliterator(), b.spliterator());
        ByteStream stream = StreamUtil.byteStream(split, a.isParallel() || b.isParallel());
        return stream.onClose(Streams.composedClose(a, b));
    }

    /**
     * A mutable builder for a {@code ByteStream}.
     *
     ...
     *
     * @see ByteStream#builder()
     * @since 1.8
     */
    final class Builder implements ByteConsumer, ByteSpliterator {
        ...
        public ByteStream build() {
            ...
            if (c >= 0) {
                ...
                return (c < 2) ? StreamUtil.byteStream(this, false)
                        : StreamUtil.byteStream(buffer.spliterator(), false);
            }
