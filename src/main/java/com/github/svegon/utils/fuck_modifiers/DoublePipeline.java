 ...
 * stage implementing whose elements are of type {@code doubles}.
 *
...
public abstract class DoublePipeline<E_IN> extends AbstractPipeline<E_IN, Double, DoubleStream> implements DoubleStream {
    ...
    public final DoubleStream distinct() {
        ...
        // An efficient version requires a doubles-specific map/set implementation.
     ...
     * {@inheritDoc}
     *
     * @implNote The {@code doubles} format can represent all
