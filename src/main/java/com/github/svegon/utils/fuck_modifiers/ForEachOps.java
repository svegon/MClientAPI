...
public final class ForEachOps {
    ...
    /**
     * Constructs a {@code TerminalOp} that perform an action for every element
     * of a {@code BooleanStream}.
     *
     * @param action the {@code BooleanConsumer} that receives all elements of
     *        a stream
     * @param ordered whether an ordered traversal is requested
     * @return the {@code TerminalOp} instance
     */
    public static TerminalOp<Boolean, Void> makeBoolean(BooleanConsumer action, boolean ordered) {
        Objects.requireNonNull(action);
        return new ForEachOp.OfBoolean(action, ordered);
    }

    /**
     * Constructs a {@code TerminalOp} that perform an action for every element
     * of a {@code ByteStream}.
     *
     * @param action the {@code ByteConsumer} that receives all elements of
     *        a stream
     * @param ordered whether an ordered traversal is requested
     * @return the {@code TerminalOp} instance
     */
    public static TerminalOp<Byte, Void> makeByte(ByteConsumer action, boolean ordered) {
        Objects.requireNonNull(action);
        return new ForEachOp.OfByte(action, ordered);
    }

    /**
     * Constructs a {@code TerminalOp} that perform an action for every element
     * of a {@code ShortStream}.
     *
     * @param action the {@code ShortConsumer} that receives all elements of
     *        a stream
     * @param ordered whether an ordered traversal is requested
     * @return the {@code TerminalOp} instance
     */
    public static TerminalOp<Short, Void> makeShort(ShortConsumer action, boolean ordered) {
        Objects.requireNonNull(action);
        return new ForEachOp.OfShort(action, ordered);
    }
    ...
    /**
     * Constructs a {@code TerminalOp} that perform an action for every element
     * of a {@code CharStream}.
     *
     * @param action the {@code CharConsumer} that receives all elements of
     *        a stream
     * @param ordered whether an ordered traversal is requested
     * @return the {@code TerminalOp} instance
     */
    public static TerminalOp<Character, Void> makeChar(CharConsumer action, boolean ordered) {
        Objects.requireNonNull(action);
        return new ForEachOp.OfChar(action, ordered);
    }

    /**
     * Constructs a {@code TerminalOp} that perform an action for every element
     * of a {@code FloatStream}.
     *
     * @param action the {@code FloatConsumer} that receives all elements of
     *        a stream
     * @param ordered whether an ordered traversal is requested
     * @return the {@code TerminalOp} instance
     */
    public static TerminalOp<Float, Void> makeFloat(FloatConsumer action, boolean ordered) {
        Objects.requireNonNull(action);
        return new ForEachOp.OfFloat(action, ordered);
    }
    ...
    abstract static class ForEachOp<T>
        ...
        /** Implementation class for {@code BooleanStream} */
        public static final class OfBoolean extends ForEachOp<Boolean> implements Sink.OfBoolean {
            public final BooleanConsumer consumer;

            public OfBoolean(BooleanConsumer consumer, boolean ordered) {
                super(ordered);
                this.consumer = consumer;
            }
        ...
        public static final class OfDouble extends ForEachOp<Double>
    ...
    public static final class ForEachOrderedTask<S, T> extends CountedCompleter<Void> {
        ...
        public ForEachOrderedTask(PipelineHelper<T> helper,
                                     Spliterator<S> spliterator,
                                     Sink<T> action) {
            super(null);
            this.helper = helper;
        ...
        public ForEachOrderedTask(ForEachOrderedTask<S, T> parent,
                           Spliterator<S> spliterator,
