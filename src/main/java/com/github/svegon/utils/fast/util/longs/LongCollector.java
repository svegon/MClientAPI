...
public interface LongCollector<A, R> {
    ...
    static <A, R> LongCollector<A, R> of(Supplier<A> supplier, ObjLongConsumer<A> accumulator,
                                         BinaryOperator<A> combiner, Function<A, R> finisher,
                                         ImmutableEnumSet<Collector.Characteristics> characteristics) {
        return new LongCollectorImpl<>(Preconditions.checkNotNull(supplier), Preconditions.checkNotNull(accumulator),
    ...
    final class LongCollectorImpl<A, R> implements LongCollector<A, R> {
        ...
        private LongCollectorImpl(Supplier<A> supplier, ObjLongConsumer<A> accumulator,
                                     BinaryOperator<A> combiner, Function<A, R> finisher,
                                     ImmutableEnumSet<Collector.Characteristics> characteristics) {
