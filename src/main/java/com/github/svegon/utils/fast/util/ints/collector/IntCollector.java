package com.github.svegon.utils.fast.util.ints.collector;
...
public interface IntCollector<A, R> {
    ...
    static <A, R> IntCollector<A, R> of(Supplier<A> supplier, ObjIntConsumer<A> accumulator,
                                        BinaryOperator<A> combiner, Function<A, R> finisher,
                                        ImmutableEnumSet<Collector.Characteristics> characteristics) {
        return new IntCollectorImpl<>(Preconditions.checkNotNull(supplier), Preconditions.checkNotNull(accumulator),
    ...
    final class IntCollectorImpl<A, R> implements IntCollector<A, R> {
        ...
        private IntCollectorImpl(Supplier<A> supplier, ObjIntConsumer<A> accumulator,
                                     BinaryOperator<A> combiner, Function<A, R> finisher,
                                     ImmutableEnumSet<Collector.Characteristics> characteristics) {
