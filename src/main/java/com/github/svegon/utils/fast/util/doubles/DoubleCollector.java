...
public interface DoubleCollector<A, R> {
    ...
    static <A, R> DoubleCollector<A, R> of(Supplier<A> supplier, ObjDoubleConsumer<A> accumulator,
                                           BinaryOperator<A> combiner, Function<A, R> finisher,
                                           ImmutableEnumSet<Collector.Characteristics> characteristics) {
        return new DoubleCollectorImpl<>(Preconditions.checkNotNull(supplier), Preconditions.checkNotNull(accumulator),
    ...
    final class DoubleCollectorImpl<A, R> implements DoubleCollector<A, R> {
        ...
        private DoubleCollectorImpl(Supplier<A> supplier, ObjDoubleConsumer<A> accumulator,
                                     BinaryOperator<A> combiner, Function<A, R> finisher,
                                     ImmutableEnumSet<Collector.Characteristics> characteristics) {
