...
public final class SingletonImmutableBooleanSortedSet extends ImmutableBooleanSortedSet {
    ...
    public BooleanSortedSet headSet(boolean toElement) {
        return actualComparator.compare(value, toElement) < 0 ? this : ImmutableBooleanSortedSet.empty(comparator());
    }

    @Override
    public BooleanSortedSet tailSet(boolean fromElement) {
        return actualComparator.compare(value, fromElement) < 0 ? ImmutableBooleanSortedSet.empty(comparator()) : this;
    }
